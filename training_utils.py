...
def get_maml_overfitting_experiment_folder(CONFIG, subfolder: str = None) -> str:
    """Create string with experiment name and get number of experiment."""
    exp_name = '_'.join([
        CONFIG.dataset, 'maml_epochs' + str(CONFIG.maml_epochs), 'epochs' + str(CONFIG.epochs), 'max_len' + str(CONFIG.max_len)])
    if subfolder:
...
def get_maml_folder(CONFIG) -> str:
    """Create string with experiment name and get number of experiment."""
    exp_name = '_'.join([
        'MAML', CONFIG.maml_dataset, 'batch_size' + str(CONFIG.maml_batch_size), 'epochs' + str(CONFIG.maml_epochs)])
